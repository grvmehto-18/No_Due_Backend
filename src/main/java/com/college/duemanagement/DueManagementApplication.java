        ...
        return args -> {
            ...
            if (roleRepository.count() == 0) {
                roleRepository.saveAll(Arrays.asList(
                        ...
                        new Role(null, Role.ERole.ROLE_DEPARTMENT_ADMIN),
                        new Role(null, Role.ERole.ROLE_HOD),
                        new Role(null, Role.ERole.ROLE_PRINCIPAL),
                        new Role(null, Role.ERole.ROLE_STUDENT)
                ));
            }
